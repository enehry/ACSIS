    ...
    <nav style="background-color: #211838;" class="navbar navbar-dark navbar-expand-lg">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/advisory-council">Advisory List</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="/notification-list"><i class="fas fa-bell"></i>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <img style="height: 30px;" class="rounded-circle border border-light" src="{{ Auth::user()->avatar }}" alt="Avatar" class="avatar">
              @else
