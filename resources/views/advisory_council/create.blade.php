...
@section('content')
    <div class="workSpace">
        <div class="title1">
            <h3>Advisory Council / Create New</h3>
        </div>
        ...
        <div class="content1">
            ...
            <div class="centerBox">
                ...
                <form method="post" action="{{ route('advisory-council.store') }}">
                    @csrf
                            ...
                            <div class="haddress">
                                ...
                                <div class="brngy">
                                    ...
                                    <input class="@error('brgy') is-invalid @enderror" type="text" placeholder="Barangay"
                                        name="brgy" required value="{{ old('brgy') }}">
                                </div>
                                <div class="city">
                                    <span class="Name"> </span><br>
                                ...
                                <div class="province">
                                    ...
                                    <input class="@error('province') is-invalid @enderror" type="text"
                                        placeholder="Province" name="province" required value="{{ old('province') }}">
                                </div>
                            </div>
                        </div>
                    </fieldset>
