...
<head>
    ...
    <link rel="stylesheet" href="../css/maintenance/policeStrategyManagementUnit.css">
...
<body>
    ...
    <div class="workSpace">
        <div class="title1">
            <h3>Police Strategy Manamgent Unit</h3>
        </div>
                        ...
                        <div class="pso">
                            <div class="psmuPos">
                                ...
                                <select id="acOffice" name="acOffice">
                                    ...
                                    <option value="option4">N   ational Operations Support Unit</option>
